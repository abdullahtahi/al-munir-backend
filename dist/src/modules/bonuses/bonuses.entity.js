...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => consultant_entity_1.Consultant, { foreignKey: 'fkConsultantId', as: 'fkConsultant' }),
    (0, sequelize_typescript_1.BelongsTo)(() => consultant_entity_1.Consultant, { foreignKey: 'fkFromConsultantId', as: 'fkFromConsultant' }),
    (0, sequelize_typescript_1.BelongsTo)(() => admissions_entity_1.Admissions, { foreignKey: 'fkAdmissionId', as: 'admission' }),
    (0, sequelize_typescript_1.Column)({
